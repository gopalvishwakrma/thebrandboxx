...
Route::post('/cart/removeFromCart1', 'CartController@removeFromCart1')->name('cart.removeFromCart1');
...
Route::group(['middleware' => ['checkout', 'verified']], function(){
	...
	Route::post('/checkout/payment_select', 'CheckoutController@store_shipping_info')->name('checkout.payment_select'); // custom by gopal
});
...
// CITIGATE Start
Route::get('/citigate/pay', 'CitigateController@index');
Route::POST('/citigate/success', 'CitigateController@success');
Route::POST('/citigate/fail', 'CitigateController@fail');
Route::get('/citigate/fail', 'CitigateController@fail');
Route::POST('/citigate/cancel', 'CitigateController@cancel');
Route::POST('/citigate/ipn', 'CitigateController@ipn');
//CITIGATE END
...
Route::get('/ppc', 'HomeController@ppc')->name('ppc');
Route::get('/orm', 'HomeController@orm')->name('orm');
Route::get('/social', 'HomeController@social')->name('social');
Route::get('/wdd', 'HomeController@wdd')->name('wdd');
Route::get('/em', 'HomeController@em')->name('em');
...
//Route::get('/ldd', 'HomeController@ldd')->name('ldd');
//Route::get('/services', 'HomeController@consulting_services')->name('services');
Route::get('/aboutus', 'HomeController@aboutus')->name('aboutus');
Route::get('/contactus', 'HomeController@contactus')->name('contactus');

Route::get('/addresses', 'HomeController@addresses')->name('addresses');
Route::get('/account', 'HomeController@account')->name('account');

Route::get('/t&c', 'HomeController@termsandconditions')->name('termsandconditions');
Route::get('/privacypolicy', 'HomeController@privacypolicy')->name('privacypolicy');
