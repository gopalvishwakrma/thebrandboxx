    ...
    public function store(Request $request)
    {
        ...
        if($order->save()){
            ...
            foreach (Session::get('cart') as $key => $cartItem){
                ...
                //$order_detail->price = single_price_payment($cartItem['price'] * $cartItem['quantity']); //commented if there is multiple currency
          	...
          	//$total = single_price_payment($total); //for currency passing if multiple currency
			
          	//dd($total);
            $order->grand_total = convertPrice($subtotal + $tax + $shipping);
