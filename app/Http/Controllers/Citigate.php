...
class Citigate
{
    ...
    public function initiate($post_data, $get_pay_options = false)
    {
        if ($post_data != '' && is_array($post_data)) {
            ...
            //$paymentGatewayurl = "https://gw-test.cgate.tech/orion/hosted/Payment.aspx?". http_build_query($post_data);

            //header("Location: https://gw-test.cgate.tech/orion/hosted/Payment.aspx?" . http_build_query($post_data));
