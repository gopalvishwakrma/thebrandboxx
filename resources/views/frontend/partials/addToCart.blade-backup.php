               ...
               @if(home_price($product->id) != home_discounted_price($product->id))
                ...
                <div class="width-100 mt-3">
                    <div class="text-center">
                        <!-- Add to cart button -->
                        @if ($qty > 0)
                            <button type="button" class="btn atc mt-auto text-center add-to-cart" onclick="addToCart()">
                                <i class="la la-shopping-cart"></i>
                                <span class="d-none d-md-inline-block"> {{__('Add to cart')}}</span>
                            </button>
                        @else
                            <button type="button" class="btn btn-styled btn-base-3 btn-icon-left strong-700 w-100" disabled>
