                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-box bg-white mt-4">
                                    ...
                                    @php
                                        $Customer_packages = \App\CustomerPackage::find(Auth::user()->customer_package_id);
                                    @endphp
                                    <div class="form-box-content p-3">
                                        @if($Customer_packages != null)
                                            <div class="form-box-content p-2 category-widget text-center">
                                                ...
                                                <strong><p><div class="name mb-0">{{__('Current Package')}}: <span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span></div></p></strong>
                                            </div>
                                        @else
                                            <div class="form-box-content p-2 category-widget text-center">
